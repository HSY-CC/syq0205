        ...
        var a = e("./GameManager"),
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    1 != e && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[e - 1], this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[e - 1]), this.continueTip.getComponent(cc.Label).string = 1 == e ? "\u70b9\u51fb\u7ee7\u7eed" : 2 == e ? "\u9ede\u64ca\u7e7c\u7e8c" : 4 == e ? "\ud074\ub9ad \ud558\uc5ec \uacc4\uc18d" : "Click Continue";
                    var t = i.default.returnCurrentLanType();
                    this.adsButton2.active = 1 == t, this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.5, 1.1), cc.scaleTo(.55, 1), cc.delayTime(.5)))), cc.tween(this.moreGameBtn).to(.5, {
                        scale: 1.1
                    }).to(.5, {
                        scale: 1
                    ...
                    window.location.href = "https://i.y.qq.com/v8/playsong.html?songid=653045&source=yqq#wechat_redirect"
    ...
    InputController: [function(e, t, n) {
        ...
        var a = e("./GameFunction"),
            ...
            p = function(e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return t.Rocker = null, t.stick = null, t.Max_r = 100, t.RockerJS = null, t.speed = 400, t.Arrow = null, t.knife = null, t.startPoint = null, t.touchPoint = null, t.endPoint = null, t.ddir = cc.v2(0, 0), t.isCut = !1, t.comboTime = 0, t.comboInterval = .4, t.comboNumber = 0, t.comboMaxNum = 7, t.autoCreateFruit = 0, t.createFruitCount = 0, t.istest = !1, t
                }
                var n;
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    null != n.Instance && n.Instance.destroy(), n.Instance = this
                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && (a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function() {
                        0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0), t.createFruitCount++) : t.createFruitCount >= 1 && (a.default.Instance.createOneFruit(s.default.RandomInteger(1, 5)), t.createFruitCount++)
                    }, .5))
    ...
    MainGameJS: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                o.mainGameJs = this, o.publicGameBool
            },
            play: function() {
                console.log(1);
                var e = this;
            ...
            initEndLayer: function() {
                this.gameOverT1.node.active = !1, this.gameOverT2.node.active = !1, this.gameOverToEnd.active = !1, 1 == this.returnCurrentLanType() ? this.showAdsLayer() : o.publicGameBool || adBreak({
                    type: "next",
                    name: "restart-game"
                }), a.gotoEndLayer1()
            },
        ...
        var a = e("../common/PlayerInfo"),
            ...
            f = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    this.ShowScorePanel(), s.default.Instance.GetLevel() % 5 == 1 ? (this.passlevelYQ = .12, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 2 ? (this.passlevelYQ = .31, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 3 ? (this.passlevelYQ = .51, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 4 ? (this.passlevelYQ = .71, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 0 && (this.passlevelYQ = 1, this.lerpCtrl = !0);
                    var e = l.default.returnCurrentLanType();
                    this.adsButton.active = 1 == e, cc.tween(this.adsButton.children[0].children[0]).to(.5, {
                        scale: 1.2
                    }).to(.5, {
                        scale: 1
                    }).union().repeatForever().start()
                ...
                }, t.Instance = null, c([p(cc.Node)], t.prototype, "mainCamera", void 0), c([p(cc.Node)], t.prototype, "bgLayer", void 0), c([p(cc.Label)], t.prototype, "scoreLabel", void 0), c([p(cc.Node)], t.prototype, "scorePanel", void 0), c([p(cc.Node)], t.prototype, "guidePanel", void 0), c([p(cc.Node)], t.prototype, "injuredPanel", void 0), c([p(cc.Node)], t.prototype, "levelPanel", void 0), c([p(cc.Node)], t.prototype, "levelProgress", void 0), c([p(cc.Node)], t.prototype, "heartPanel", void 0), c([p(cc.Node)], t.prototype, "congratulation", void 0), c([p(cc.Node)], t.prototype, "adsButton", void 0), c([p(cc.Node)], t.prototype, "player", void 0), t = n = c([d], t)
            }(cc.Component);
        n.default = f, cc._RF.pop()
    }, {
        "../Common/Utils": "Utils",
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
                        ...
                        if (c == r && c < 12 && r < 12 ? (this.pengzhuangCount += 1, 0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + 1, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(t.node).to(.1, {
                            ...
                            }).start())) : c == r && 12 == c && 12 == r && (this.pengzhuangCount += 1, 0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + 1, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(t.node).to(.1, {
                                position: n.node.position
                            }).call(function() {
                                i.default.Instance.createFruitSui(o.fruitNumber, n.node.position), i.default.Instance.createFruitL(o.fruitNumber, n.node.position, n.node.width), i.default.Instance.createLevelUpFruit(o.fruitNumber + 1, n.node.position), n.node.active = !1, t.node.active = !1, n.node.destroy(), t.node.destroy()
                            }).start())), c == r && 9 == c && 9 == r) {
                            a.default.playerTouch = !1;
                            var s = cc.find("Canvas/upEffectParent").getChildByName("daxigua");
                            s.active = !0, s.opacity = 0, cc.tween(s).to(.5, {
                                opacity: 150
                            }).start();
                            var p = new cc.Node;
                            p.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10], p.parent = cc.find("Canvas/upEffectParent"), p.position = cc.v2(0, -500), p.scale = 0;
                            var f = new cc.Node;
                            f.addComponent(cc.Sprite).spriteFrame = l.default.Instance.caidia[6], f.scale = 1, f.parent = p, f.position = cc.v2(0), cc.tween(f).by(5, {
                                angle: 360
                            }).repeatForever().start();
                            var h = new cc.Node;
                            h.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10], h.parent = p, h.position = cc.v2(0), d.default.Instance.Play(4, !1, 1), i.default.Instance.ribbonEffect(cc.v2(0, 0)), p.runAction(cc.sequence(cc.spawn(cc.jumpBy(1, 0, 0, 300, 1), cc.scaleTo(1, 3)), cc.delayTime(1), cc.spawn(cc.moveTo(1, cc.v2(0, 500)), cc.scaleTo(1, 0)), cc.callFunc(function() {
                                a.default.score += 100, u.default.Instance.SetScoreTween(a.default.score), s.active = !1, a.default.playerTouch = !0, p.destroy()
                            })))
                        }
                    }
